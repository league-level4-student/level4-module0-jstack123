...
public class Cell implements Drawable {
	 ...
	 * underpopulation. 2. Any live cell with two or three live neighbours lives
	 * onto the next generation. 3. Any live cell with more than three live
	 * neighbours dies, as if by overpopulation. 4. Any dead cell with exactly three
	 * live neighbours becomes a live cell, as if by reproduction. (source:
	 * Wikipedia)
	 */
